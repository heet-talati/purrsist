...
8. Are the goals going to be categorized?
9. Can the user create custom categories for goals?
10. What happens when the user exceed the max active goal limit?
11. Is there a way to put goals in a waiting queue?
12. Can the user track time without assigning it to a goal?
13. What happens if the user don't have any time allocated to a goal for a certain period of time, does the goal become inactive?
14. Does the user get reminders if a goal hasn't had any activity for a certain period of time?
15. How can the user track time for people with focus issues?
16. How can the user track time for people who enter flow state after a certain period of time; without disturbing them?
17. What if the user starts doing things that are not related to goal while in session?
18. How does the user know what they worked on without eventually forgetting?
19. How can the users log their work without spending a lot of time journaling?
